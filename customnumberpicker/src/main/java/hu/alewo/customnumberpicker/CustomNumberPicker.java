package hu.alewo.customnumberpicker;
...
public class CustomNumberPicker extends LinearLayout {
    ...
    public interface OnScrollListener {
         ...
         *                    {@link #SCROLL_STATE_IDLE}.
         */
        public void onScrollStateChange(CustomNumberPicker view, @CustomNumberPicker.OnScrollListener.ScrollState int scrollState);
    }
...
//        }
    ...
    private void setValueInternal(int current, boolean notifyChange) {
        ...
        if (mScrollState != CustomNumberPicker.OnScrollListener.SCROLL_STATE_FLING) {
            updateInputTextView();
        }
        if (notifyChange) {
    ...
    private void onScrollerFinished(Scroller scroller) {
        if (scroller == mFlingScroller) {
            ensureScrollWheelAdjusted();
            updateInputTextView();
            onScrollStateChange(CustomNumberPicker.OnScrollListener.SCROLL_STATE_IDLE);
        } else if (mScrollState != CustomNumberPicker.OnScrollListener.SCROLL_STATE_TOUCH_SCROLL) {
            updateInputTextView();
        }
    }
    ...
    private CustomNumberPicker.Formatter stringToFormatter(final String formatter) {
        if (TextUtils.isEmpty(formatter)) {
            return null;
        }

        return new CustomNumberPicker.Formatter() {
            @Override
     ...
     */
    public void setOrder(@CustomNumberPicker.Order int order) {
        mOrder = order;
    }

    public void setOrientation(@CustomNumberPicker.Orientation int orientation) {
    ...
    public void setSelectedTextAlign(@CustomNumberPicker.Align int align) {
    ...
    public void setTextAlign(@CustomNumberPicker.Align int align) {
        mTextAlign = align;
    }
    ...
    public CustomNumberPicker.Formatter getFormatter() {
        return mFormatter;
    }
